...
<div class="right-menu">
            <form action ="/editarticle" method="post">
                <div class="modal-body form">
                    ...
                    <textarea type="text" placeholder="<%=article.getTitle()%>" name = "title" style="margin-bottom: 10px"><%=article.getTitle()%></textarea>
                    <p>Enter the short content</p>
                    <textarea type="text" class="content-area" name = "short_content" style="margin-bottom: 10px" value="<%=article.getShortContent()%>"><%=article.getShortContent()%></textarea><br>
                    <p>Enter the main content</p>
                    <textarea type="text" class="main-content" name = "main_content" style="margin-bottom: 10px" value="<%=article.getContent()%>"><%=article.getContent()%></textarea>
                    <p>Add the picture's URL</p>
                    <input type="text" placeholder="URL of the picture" name = "url" style="margin-bottom: 10px" value="<%=article.getPictureUrl()%>"><br>
